...
public class TreeImpl<E extends Comparable<? super E>> implements Tree<E> {
    ...
    public boolean add(E value) {
        ...
        if (nodeAndParent.parrentLevel == levelMAX) {
            return false;
        }
    ...
    private NodeAndParent doFind(E value) {
        ...
        Node<E> current = root;
        NodeAndParent result;
        int currentLevel = 0;

        while (current != null) {
            if (current.getValue().equals(value)) {
                result = new NodeAndParent(current, previous);
                result.parrentLevel = currentLevel;
                return result;
            }
            currentLevel++;
            previous = current;
        ...
        result = new NodeAndParent(null, previous);
        result.parrentLevel = currentLevel;
        return result;
    }
